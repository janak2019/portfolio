...
const amount = (value) => npr.format(value || 0);
...
export default function SalaryResult({ result }) {
  ...
  return (
    <>
      {/* Screen Result */}
      <aside className="h-fit min-w-0 rounded-2xl border border-cyan-400/30 bg-slate-900 p-4 shadow-xl sm:p-7 print:hidden">
        ...
        <div className="mt-6 rounded-lg bg-slate-950 p-4 text-xs leading-5 text-slate-400">
          ...
          राखिएको छ। अस्थायी/करार सेवाका भत्ता र कट्टी फरक हुन सक्ने भएकाले
          आफ्नो कार्यालयबाट पुष्टि गर्नुहोस्।
        </div>
      ...
      <div className="salary-print">
        ...
        <div className="print-footer">
          ...
          <span>मुद्रण मिति: {new Date().toLocaleDateString("ne-NP")}</span>
        </div>
      </div>
    </>
  );
