...
// निजामती सेवा
  ...
  { id: "level-five-18", category: "civil", label: "पाँचौं स्तर (क्र.सं. १८)", basic: 43794, maxGrade: 4, gradeRate:1460 },
  { id: "level-four-19", category: "civil", label: "चतुर्थ स्तर (क्र.सं. १९)", basic: 41391, maxGrade: 2, gradeRate: 1380 },
  ...
  { id: "halkara-four", category: "civil", label: "हलकारा — चतुर्थ स्तर", basic: 33789, maxGrade: 2, gradeRate: 1126 },
  { id: "halkara-three", category: "civil", label: "हलकारा — तृतीय स्तर", basic: 31891, maxGrade: 2, gradeRate: 1063 },
  { id: "halkara-two", category: "civil", label: "हलकारा — द्वितीय स्तर", basic: 30146, maxGrade: 2, gradeRate: 1005 },
  { id: "halkara-one", category: "civil", label: "हलकारा — प्रथम स्तर", basic: 28690, maxGrade: 2, gradeRate: 956 },
  { id: "hulaki-five", category: "civil", label: "हुलाकी — पाँचौं स्तर", basic: 36445, maxGrade: 4, gradeRate: 1215 },
  ...
  { id: "hulaki-two", category: "civil", label: "हुलाकी — द्वितीय स्तर", basic: 28918, maxGrade: 2, gradeRate: 964 },
  ...
  { id: "office-assistant-one", category: "civil", label: "कार्यालय सहयोगी — प्रथम स्तर", basic: 27172, maxGrade: 2, gradeRate: 906 },
  // नेपाल प्रहरी
  { id: "police-1", category: "police", label: "प्र. महा-निरीक्षक", basic: 79290, maxGrade: 2 },
  { id: "police-2", category: "police", label: "प्र. अ. महा-निरीक्षक", basic: 79290, maxGrade: 2 },
  ...
  { id: "police-7", category: "police", label: "प्र. निरीक्षक", basic: 48058, maxGrade: 8 },
  { id: "police-8", category: "police", label: "प्र. वरिष्ठ नायव निरीक्षक", basic: 45098, maxGrade: 5 },
  { id: "police-9", category: "police", label: "प्र. ना. निरीक्षक", basic: 38203, maxGrade: 8 },
  { id: "police-10", category: "police", label: "प्र. सहायक निरीक्षक", basic: 36142, maxGrade: 7 },
  { id: "police-11", category: "police", label: "प्र. व. हवल्दार", basic: 31372, maxGrade: 6 },
  { id: "police-12", category: "police", label: "प्र. हवल्दार", basic: 30373, maxGrade: 7 },
  { id: "police-13", category: "police", label: "प्र. सहायक हवल्दार", basic: 29209, maxGrade: 8 },
  { id: "police-14", category: "police", label: "प्र. जवान", basic: 28690, maxGrade: 8 },
  { id: "police-15", category: "police", label: "रिक्रुट", basic: 27172, maxGrade: 0 },
  ...
  { id: "police-20", category: "police", label: "प्र.का.स. प्रथम स्तर", basic: 27172, maxGrade: 2 },
  // नेपाली सेना
  { id: "army-1", category: "army", label: "प्रधान सेनापति", basic: 84932, maxGrade: 2 },
  { id: "army-2", category: "army", label: "रथी", basic: 81646, maxGrade: 2 },
  { id: "army-3", category: "army", label: "उप रथी", basic: 79290, maxGrade: 2 },
  { id: "army-4", category: "army", label: "सहायक रथी", basic: 67045, maxGrade: 5 },
  { id: "army-5", category: "army", label: "महा सेनानी", basic: 62466, maxGrade: 5 },
  { id: "army-6", category: "army", label: "प्रमुख सेनानी", basic: 57507, maxGrade: 6 },
  { id: "army-7", category: "army", label: "सेनानी", basic: 53611, maxGrade: 8 },
  ...
  { id: "army-10", category: "army", label: "सहायक सेनानी", basic: 48058, maxGrade: 0 },
  ...
  { id: "army-13", category: "army", label: "मानार्थ उप-सेनानी", basic: 46628, maxGrade: 0 },
  { id: "army-14", category: "army", label: "प्रमुख सुवेदार", basic: 45098, maxGrade: 3 },
  { id: "army-15", category: "army", label: "सुवेदार", basic: 38302, maxGrade: 7 },
  { id: "army-16", category: "army", label: "जमदार", basic: 36142, maxGrade: 6 },
  { id: "army-17", category: "army", label: "हु.गा.हुद्दा", basic: 31372, maxGrade: 6 },
  { id: "army-18", category: "army", label: "अमलदार", basic: 30373, maxGrade: 7 },
  { id: "army-19", category: "army", label: "प्युठ", basic: 29297, maxGrade: 8 },
  { id: "army-20", category: "army", label: "सिपाही", basic: 28690, maxGrade: 8 },
  { id: "army-21", category: "army", label: "रिक्रुट", basic: 27172, maxGrade: 0 },
  { id: "army-22", category: "army", label: "मेन्ट क्राफ्टेट", basic: 27772, maxGrade: 10 },

  // विमान समूह सम्बन्धी
  { id: "army-23", category: "army", label: "पाइलट उपरी", basic: 84853, maxGrade: 2 },
  { id: "army-24", category: "army", label: "सहायक रथी", basic: 77798, maxGrade: 5 },
  { id: "army-25", category: "army", label: "महा सेनानी", basic: 69600, maxGrade: 5 },
  { id: "army-26", category: "army", label: "प्रमुख सेनानी", basic: 67944, maxGrade: 5 },
  { id: "army-27", category: "army", label: "सेनानी", basic: 64844, maxGrade: 8 },
  { id: "army-28", category: "army", label: "सह-सेनानी", basic: 60050, maxGrade: 6 },
  { id: "army-29", category: "army", label: "उप-सेनानी", basic: 57659, maxGrade: 6 },
  { id: "army-30", category: "army", label: "वरिष्ठ सुवेदार", basic: 467893, maxGrade: 7 },
  { id: "army-31", category: "army", label: "सुवेदार", basic: 40176, maxGrade: 7 },
  { id: "army-32", category: "army", label: "जमदार", basic: 39417, maxGrade: 6 },
  { id: "army-33", category: "army", label: "हुद्दा", basic: 34155, maxGrade: 6 },
  ...
  { id: "army-39", category: "army", label: "फलोअर्स प्रथम स्तर", basic: 27172, maxGrade: 2 },
  
  // सशस्त्र प्रहरी बल, नेपाल

  { id: "apf-1", category: "apf", label: "स.प्र. महा-निरीक्षक", basic: 72290, maxGrade: 2 },
  { id: "apf-2", category: "apf", label: "स.प्र. अ. महा-निरीक्षक", basic: 72290, maxGrade: 2 },
  ...
  { id: "apf-7", category: "apf", label: "स.प्र. निरीक्षक", basic: 48058, maxGrade: 8 },
  { id: "apf-8", category: "apf", label: "स.प्र. वरिष्ठ नायव निरीक्षक", basic: 45098, maxGrade: 2 },
  { id: "apf-9", category: "apf", label: "स.प्र. ना. निरीक्षक", basic: 38203, maxGrade: 6 },
  { id: "apf-10", category: "apf", label: "स.प्र. सहायक निरीक्षक", basic: 36142, maxGrade: 7 },
  { id: "apf-11", category: "apf", label: "स.प्र. व. हवल्दार", basic: 31372, maxGrade: 6 },
  { id: "apf-12", category: "apf", label: "स.प्र. हवल्दार", basic: 30373, maxGrade: 7 },
  { id: "apf-13", category: "apf", label: "स.प्र. सहायक हवल्दार", basic: 29209, maxGrade: 8 },
  { id: "apf-14", category: "apf", label: "स.प्र. जवान", basic: 28690, maxGrade: 8 },
  { id: "apf-15", category: "apf", label: "रिक्रुट श्रेणी विहीन", basic: 27172, maxGrade: 0 },
  { id: "apf-16", category: "apf", label: "फलोअर्स (सयश समेत)", basic: 27172, maxGrade: 10 },
  ...
  { id: "apf-21", category: "apf", label: "प्र.का.स. प्रथम स्तर", basic: 27172, maxGrade: 2 },
// स्वास्थ्य सेवा
  { id: "health-1", category: "health", label: "अधिकृत बाह्रौं", basic: 79290, maxGrade: 2 },
  ...
  { id: "health-7", category: "health", label: "अधिकृत छैठौं", basic: 48058, maxGrade: 5 },
  { id: "health-8", category: "health", label: "वरिष्ठ पाँचौं", basic: 41517, maxGrade: 5 },
  { id: "health-9", category: "health", label: "सहायक पाँचौं", basic: 38203, maxGrade: 6 },
  { id: "health-10", category: "health", label: "सहायक चौथौं", basic: 36192, maxGrade: 7 },
  ...
  { id: "health-13", category: "health", label: "सहायक प्रथम", basic: 27172, maxGrade: 10 },
  ...
  // संसद सेवा
  { id: "parliament-1", category: "parliament", label: "विशिष्ट", basic: 79290, maxGrade: 2 },
  ...
  { id: "parliament-4", category: "parliament", label: "द्वितीय", basic: 53611, maxGrade: 8 },
  { id: "parliament-5", category: "parliament", label: "तृतीय", basic: 48058, maxGrade: 8 },

  { id: "parliament-6", category: "parliament", label: "प्रथम अ.मा.", basic: 41517, maxGrade: 0 },
  { id: "parliament-7", category: "parliament", label: "प्रथम", basic: 38203, maxGrade: 10 },
  { id: "parliament-8", category: "parliament", label: "द्वितीय अ.मा.प्रा.", basic: 37407, maxGrade: 0 },
  { id: "parliament-9", category: "parliament", label: "द्वितीय", basic: 36192, maxGrade: 10 },
  ...
  { id: "parliament-12", category: "parliament", label: "हेभी सवारी चालक - पाँचौं तह", basic: 45717, maxGrade: 4 },
  { id: "parliament-13", category: "parliament", label: "हेभी सवारी चालक - चतुर्थ तह", basic: 43794, maxGrade: 2 },
  { id: "parliament-14", category: "parliament", label: "हेभी सवारी चालक - तृतीय तह", basic: 41391, maxGrade: 2 },
  ...
  { id: "parliament-17", category: "parliament", label: "हलुका सवारी चालक - पाँचौं तह", basic: 43794, maxGrade: 4 },
  { id: "parliament-18", category: "parliament", label: "हलुका सवारी चालक - चतुर्थ तह", basic: 41391, maxGrade: 2 },
  ...
  { id: "parliament-22", category: "province-local", label: "छैठौं तह - पाँचौं तह", basic: 36142, maxGrade: 4 },
  { id: " parliament-23", category: "province-local", label: "छैठौं तह - चतुर्थ तह", basic: 32701, maxGrade: 2 },
  { id: " parliament-24", category: "province-local", label: "छैठौं तह - तृतीय तह", basic: 30373, maxGrade: 2 },
  { id: " parliament-25", category: "province-local", label: "छैठौं तह - द्वितीय तह", basic: 28690, maxGrade: 2 },
  { id: " parliament-26", category: "province-local", label: "छैठौं तह - प्रथम तह", basic: 27792, maxGrade: 2 },
